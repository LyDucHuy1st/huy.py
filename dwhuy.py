...
def menu_apikey():
  ...
  print(f"""\x1b[1;97m
    ...
    │ [✓] AUTHOR   : LY DUC HUY            
    │ [✓] GITHUB   : lyduchuy1st                
    │ [✓] WHATSAPP : +840387199702         
    │ [✓] FACEBOOK  : Lý Đức Huy                
    │ [✓] DwH PRO : \033[1;32mPRO PRONOY \033[1;37m            
    └───────────────────────────────────────""")                                           
  ...
  os.system(f'xdg-open {tan}://www.facebook.com/100088981670271')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+840387199702?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def Spy():
	clear()
	#ckx()
	print(f" [1] FILE TÀI KHOẢN (SYSTEM API) ")
	print(f" [2] ACC BLD NGẪU NHIÊN ")
	print(f" [3] Gmail DwH")
	print(f" [0] Thoát")
	me=input(f' Chọn : ')
	if me in ["2", "02"]:
	...
	if me in ["1", "01","11","A","a"]:
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' Số lượng Acc : \033[1;32m'+total_ids+f' \n \033[1;37mMethod > \033[1;37mM{mthd}')
...
def bd():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Đầu số VD: 016,017,018,019')
                code = input('\033[1;37m chọn đầu số: ')
                try:
                        limit = int(input('\033[1;32m Số lượng: 2000, 3000, 5000, 10000\n\033[1;37m chọn số lượng: '))
                except ValueError:
                        limit = 5000
                ...
                with tred(max_workers=30) as sat:     
                        clear()
                        tl = str(len(user))
                        print(' Số lượng Acc : \033[1;32m'+tl)
                        print(f'\033[1;37m Đầu số ..:\033[1;32m '+code)
                        print(f'\033[1;32m Đang dò tài khoản ..... ')
...
def gml():
                ...
                with tred(max_workers=30) as sat:     
                        ...
                        print(' Số lượng Acc : \033[1;32m'+tl)
                        print(f'\033[1;37m Đầu số ..:\033[1;32m '+code)
                        print(f'\033[1;32m Đang dò tài khoản ngẫu nhiên ..... ')
                        print(f'\033[1;37m \x1b[38;5;126m Prosess started\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+codex+psx
